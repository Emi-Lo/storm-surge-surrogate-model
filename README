...
All the ERA5 data (Hersbach et al., 2020) are publicly available from the Climate Data Store (CDS) (https://doi.org/10.24381/cds.e2161bac). All the CIMP6 HighResMIP data 
(Haarsma et al., 2016) can be obtained from the Earth System Grid Federation (ESGF) data portal (https://esgf-node.ipsl.upmc.fr/search/cmip6-ipsl/).
